...
from ups.views import login_view, register_view, package_status,package_status_change, package_details, update_delivery_address,update_delivery_address_tracknum, my_packages
from . import views
...
urlpatterns = [
    ...
    path('home/', my_packages, name='home'),
]